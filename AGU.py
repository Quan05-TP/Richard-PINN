...
tf.__version__ # tensorflow 1.4cl
...
def main_loop(hydrus, depth_increment, noise, num_layers_psi, num_neurons_psi, num_layers_theta, num_neurons_theta, num_layers_K, num_neurons_K, number_random):
    ...
    output_dir = f"./results/{hydrus}/{run}"
...
main_loop(hydrus, depth_increment[0], noise[0], num_layers_psi[0], num_neurons_psi[0], num_layers_theta[0], num_neurons_theta[0], num_layers_K[0], num_neurons_K[0], number_random[0])